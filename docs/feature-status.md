...
| Hierarchy, goals, projects, routines, dependencies (`HIE`, `GOAL`, `ROU`) | **In progress** | **45%** | Finish hierarchy interaction acceptance, project authoring, parent completion/progress and roll-up presentation, milestones/measures, weekly goal allocation, routine authoring/execution, and complete dependency conflict explanations. |
