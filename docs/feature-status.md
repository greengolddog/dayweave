...
| Hierarchy, goals, projects, routines, dependencies (`HIE`, `GOAL`, `ROU`) | **In progress** | **50%** | Close controlled project/nested-authoring and hierarchy interaction acceptance; finish parent completion/progress and roll-up presentation, milestones/measures, weekly goal allocation, routine authoring/execution, and complete dependency conflict explanations. |
