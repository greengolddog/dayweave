...
final class CodexConversationController: ObservableObject {
    ...
    Only leaf items contribute flexible calendar time. has_own_effort lets a leaf goal or routine contribute its own duration; it never adds parent time alongside subtasks. Separate schedulable work belongs in a leaf task, and the user must review any proposed hierarchy change. Fixed events retain their own intervals regardless of children.
