...
object PlannerDatabaseMigrations {
    ...
    /**
     * No plaintext columns change. The encrypted payload gains typed duration, deadline,
     * own-effort, and blocker fields; the Room version prevents a rollback from erasing them.
     */
    ...
    /** No plaintext changes; older binaries must not erase unresolved progress write custody. */
    ...
    /** No plaintext columns change; protected fixed-input custody advances the rollback fence. */
